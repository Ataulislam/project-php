<?php
 ...
 require_once('../db.php');
  ...
  $users_query= mysqli_query($db, $user_select);
  $user_assoc = mysqli_fetch_assoc($users_query);
  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <?php if ($user_assoc['role']== 2 || $user_assoc['role']== 3) :?>
        ...
        <?php endif ?>
        <a href="Socials.php" class="sl-menu-link <?= $end_file_ext == 'Socials.php' ? 'active' : '' ?>">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-book tx-20"></i>
            <span class="menu-item-label">All Socials</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="services.php" class="sl-menu-link <?= $end_file_ext == 'services.php' ? 'active' : '' ?>">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-gamepad tx-20"></i>
            <span class="menu-item-label">All Sercices</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="educations.php" class="sl-menu-link <?= $end_file_ext == 'educations.php' ? 'active' : '' ?>">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-graduation-cap tx-20"></i>
            <span class="menu-item-label">Education</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="protfolios.php" class="sl-menu-link <?= $end_file_ext == 'protfolios.php' ? 'active' : '' ?>">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-archive tx-20"></i>
            <span class="menu-item-label">protfolios</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="counters.php" class="sl-menu-link <?= $end_file_ext == 'counters.php' ? 'active' : '' ?>">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-tasks tx-20"></i>
            <span class="menu-item-label">Counters</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        </a><!-- sl-menu-link -->
        <a href="testimonials.php" class="sl-menu-link <?= $end_file_ext == 'testimonials.php' ? 'active' : '' ?>">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon fa fa-quote-left tx-20"></i>
        ...
        <a href="contacts.php" class="sl-menu-link <?= $end_file_ext == 'contacts.php' ? 'active' : '' ?>">
          <div class="sl-menu-item">
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name"><span class="hidden-md-down"><?= $user_assoc['name']?></span></span>
              <img src="upload/<?= $user_assoc['profile_image']?>" class="wd-32 rounded-circle" alt="">
            </a>
    ...
    <?php
        $contacts = "SELECT COUNT(*) as total_msg, id, name, message FROM contacts WHERE status = 1 ORDER BY id DESC";
        $contact_query = mysqli_query($db, $contacts);
    ...
    <div class="sl-sideright">
      ...
      <div class="tab-content">
        <div class="tab-pane pos-absolute a-0 mg-t-60 active" id="messages" role="tabpanel">
          ...
          <?php 
          if ($contact_assoc['total_msg'] > 0) {
            
          
          foreach ($contact_query as $key => $contacts) :?>
            <a href="message-status.php?id=<?= $contacts['id']?>" class="media-list-link">
              <div class="media">
                <!-- <img src="../img/img3.jpg" class="wd-40 rounded-circle" alt=""> -->
                <div class="media-body">
                  <p class="mg-b-0 tx-medium tx-gray-800 tx-13"><?= $contacts['name']?></p>
                  <!-- <span class="d-block tx-11 tx-gray-500">2 minutes ago</span> -->
                  <p class="tx-13 mg-t-10 mg-b-0"><?= $contacts['message']?></p>
                </div>
              </div><!-- media -->
            </a>
          <?php endforeach ;
            ...
            echo "<span> No Messages Available</span> ";
          }
          ?>
